...
- List materials in this unit; add material (**page** / **link** / **file**) / reorder when permitted.
- Course-level materials (no unit) appear on [COURSE](./COURSE.md) **above** the units list — not on this page.
- **Print unit** produces one continuous packet (P0); opens print-friendly flow (route TBD).
...
- Materials: **title**, **description**, kind/badge, optional **scheduled_date**, important-now badge, print affordance
...
- **Print unit** — continuous packet of materials in order (P0; control on unit header — never overflow-only)
...
- Print unit — TBD dedicated print route (no page file until path locked)
