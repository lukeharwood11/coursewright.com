...
- Via parent chrome: [ORG_HOME](./ORG_HOME.md), [CALENDAR](./CALENDAR.md), [ANNOUNCEMENTS](./ANNOUNCEMENTS.md)

## Notes

[FEATURES.md](../FEATURES.md) — Announcements. Distinct from [BULLETIN](./BULLETIN.md). No reply thread in this phase. Parent sidebar shows a red count of unacknowledged current announcements.
