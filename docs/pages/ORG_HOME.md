...
- When viewing **another** week, **announcements** use that week’s **Sunday** as the as-of date (what would have been visible then). **Coming up** (Assigned next / Due next) always uses **today** so the Focus rail stays anchored to what’s next in real life. **Important now** appears only on the real current week.
