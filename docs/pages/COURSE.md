...
- Course **title**, **status**, optional **dates**, **grade metadata**
...
- **Instructors** (sidebar)
- Parent variant: same structure without edit controls

## Contents

- Course title; badges for status, dates, grade metadata ([STYLE_GUIDE.md](../STYLE_GUIDE.md) instructor course pattern)
