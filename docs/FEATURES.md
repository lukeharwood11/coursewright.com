...
|---------|-------------|--------|-------|
| **Marketing site** | Public home, about, pricing, contact, privacy, cookies | shipped | Home/about stay general (no named third-party tools). Pricing is **invite-only pilot** — no plan options; pilot interest → `hi@coursewright.com`. Contact emails live. Privacy + cookie policies live (PostHog + standard disclosures). Terms still a construction placeholder |
