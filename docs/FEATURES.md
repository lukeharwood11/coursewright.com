...
| **Observer** | Staff chrome and org-wide read (drafts, unpublished, answer keys, roster) with **no writes**. Owners and admins invite them. They do not invite, bill, brand, or count as a last owner/admin. Additive parent still acts only for linked students. Not the Teacher/Student view toggle. |
