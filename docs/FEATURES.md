...
| **(A) This week** | P0 | Current Sunday–Saturday **week calendar**: lesson-plan text in each day, materials after a divider, assigned = outline / due = filled. **Focus** rail: Important now + Coming up |
