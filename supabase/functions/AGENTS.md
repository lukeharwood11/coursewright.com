...
- One folder per use case, e.g. `create-course-from-course/` (**P0**), `create-course-from-template/` (**P1**)
...
- **P0 candidates:** create-course-from-course (copy units/materials), invite claim, revert cascades.
