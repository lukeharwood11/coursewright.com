...
- One folder per use case, e.g. `create-course-from-course/` (**P0**), `send-organization-invite/` (Resend), `send-announcement-notification/` (Resend), `send-product-feedback/` (Resend), `create-course-from-template/` (**P1**)
...
- **P0 candidates:** create-course-from-course (copy units/materials), send-organization-invite (Resend), send-announcement-notification (Resend), invite claim, revert cascades.
