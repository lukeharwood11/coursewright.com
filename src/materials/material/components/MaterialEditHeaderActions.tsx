...
export function MaterialEditHeaderActions({
  formId,
  saving,
  hasChanges,
  canSave = true,
  ...
  onDescription: () => void;
  /** When set (link/file materials), shown next to description / in the mobile menu. */
  ...
  async function leave() {
    await commitTitle();
    navigate(cancelTo, cancelState ? { state: cancelState } : undefined);
  }
