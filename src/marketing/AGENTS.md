...
- Do not invent dollar amounts. Pricing is **Free (for now)** — no plan cards or packaging options; note that pricing may change later. Partnership interest → `hi@coursewright.com`.
