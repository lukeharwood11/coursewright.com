...
Public marketing site: home, about, pricing, contact, privacy, cookies, and footer placeholders.

## Scope

- Unauthenticated sales and trust pages (`/`, `/about`, `/pricing`, `/contact`, `/privacy`, `/cookies`)
...
- Match [pages/HOME.md](../../docs/pages/HOME.md), [ABOUT](../../docs/pages/ABOUT.md), [PRICING](../../docs/pages/PRICING.md), [CONTACT](../../docs/pages/CONTACT.md), [PRIVACY](../../docs/pages/PRIVACY.md), [COOKIES](../../docs/pages/COOKIES.md), [CONSTRUCTION](../../docs/pages/CONSTRUCTION.md).
...
- Keep footer links in `model/footerNav.ts` so the footer and construction routes stay in sync (`ready: false` → ConstructionPage).
