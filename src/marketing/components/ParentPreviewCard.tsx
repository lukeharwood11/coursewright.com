  ...
  return (
    ...
    >
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 border-y border-[var(--line-soft)] py-2.5">
        ...
        <div className="border-b border-[var(--line-soft)] py-2.5">
      ...
      <div className="mt-4 border-l-4 border-[var(--amber)] bg-[var(--amber-tint)] py-3 pr-3 pl-3">
      ...
      <div className="mt-4">
        ...
        <p className="mt-2 text-[13.5px] font-extrabold text-[var(--ink)]">Science</p>
        <div className="mt-2 flex items-start justify-between gap-3 border-y border-[var(--line-soft)] py-2.5">
          <div className="flex min-w-0 items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-1 flex flex-wrap gap-x-3 gap-y-0.5 text-[12px] font-bold">
