...
- Staff nav includes **Calendar**, **Announcements**, and **Discussions**.

## Rules

- Keep this layer thin — no course/roster business rules. Lists come from domain `databridge/`.
- Parent chrome stays simpler than staff (This week, Calendar, Announcements, Discussions, their courses, Progress). Do not dump instructor destinations onto parent screens.
