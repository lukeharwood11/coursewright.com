...
- Thread view: posts, replies, file / material / URL attachments, **Mark as answered**
...
- Everyone who can see the thread can post. Replies are one level.
...
- Nest replies more than one level.
