...
- **Family ≠ access** — family membership is directory convenience only. Parent access stays course enrollment + `parent_student_links`. Linking a parent to a family must create or reuse that student link.
