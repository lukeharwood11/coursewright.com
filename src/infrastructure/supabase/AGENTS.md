...
- **P1 discussions** and **Activity** notifications subscribe to Realtime (`postgres_changes`) through this same client. Domain `databridge/` owns the channel; do not scatter `channel()` calls in page files.
