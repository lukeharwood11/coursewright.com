...
- Parent list of **current** announcements (same URL; student chrome / Student view)
...
- Student home and the parent list compose this domain via `parent/` dashboard data; do not put announcement CRUD in `parent/`.
- Student chrome shows a red unread count on **Announcements** for notices not yet opened.
