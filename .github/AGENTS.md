...
- Workflows call [`scripts/tf-plan.sh`](../scripts/tf-plan.sh), [`tf-apply.sh`](../scripts/tf-apply.sh), [`build-spa.sh`](../scripts/build-spa.sh), [`deploy-spa.sh`](../scripts/deploy-spa.sh), [`deploy-supabase.sh`](../scripts/deploy-supabase.sh).
